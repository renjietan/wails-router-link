...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			// 	 * ExternalLink 链接为内置的路由地址，地址为 staticRoutes 中定义
			// 	 */
			// 	children: [
			// 		{
			...
			// 		ExternalLink: 'https://element-plus.gitee.io/#/zh-CN/component/installation',
			// 		hidden: false,
			// 		cache: false,
			// 		affix: false,
			// 		isIframe: false,
			...
			// 		ExternalLink: 'https://nodejs.org/zh-cn/',
			// 		hidden: false,
			// 		cache: true,
			// 		affix: true,
			// 		isIframe: true,
			...
			// 		ExternalLink: 'https://undraw.co/illustrations',
			// 		hidden: false,
			// 		cache: true,
			// 		affix: true,
			// 		isIframe: true,
